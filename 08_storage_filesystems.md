...
```mermaid
flowchart TB
    subgraph stack["Storage Stack"]
        direction TB
        fs["📁 <b>Filesystem</b> (ext4, xfs)<br/>Files, directories, permissions"]
        lvm["📦 <b>Logical Volumes</b> (LVM)<br/>Flexible volume management<br/><i>Optional Layer</i>"]
        part["💿 <b>Partitions</b><br/>Divide physical disk"]
        phys["🖴 <b>Physical Storage</b><br/>HDD, SSD, NVMe"]
    end
    ...
    style lvm fill:#2196f3,color:#fff
    style part fill:#ff9800,color:#fff
    style phys fill:#607d8b,color:#fff
```
